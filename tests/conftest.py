...
SAMPLE_ROWS = [
    ...
    ["15/01/2026", "Stadion", "Anders", "Bo", "Carsten", "Dennis", "6", "3", "6", "0"],
    # Match 2: Anders & Carsten beat Bo & Erik 2-0
    ["22/01/2026", "Stadion", "Anders", "Carsten", "Bo", "Erik", "6", "4", "6", "3"],
    # Match 3: Anders & Erik beat Bo & Dennis 2-1 (team B wins first set)
    ["05/02/2026", "Stadion", "Bo", "Dennis", "Anders", "Erik", "6", "4", "3", "6", "2", "6"],
    # Match 4: Carsten & Erik beat Anders & Dennis 2-0 (includes a 6-0 egg)
    ["12/02/2026", "Stadion", "Carsten", "Erik", "Anders", "Dennis", "6", "1", "6", "0"],
    # Match 5: Anders & Bo beat Dennis & Erik 2-1 (tiebreak set 7-5)
    ["26/02/2026", "Stadion", "Anders", "Bo", "Dennis", "Erik", "6", "4", "3", "6", "7", "5"],
    # Match 6: Carsten & Bo beat Anders & Dennis 2-1
    ["05/03/2026", "Stadion", "Carsten", "Bo", "Anders", "Dennis", "4", "6", "6", "2", "6", "4"],
    # Match 7: Anders & Erik beat Bo & Carsten 2-0
    ["19/03/2026", "Stadion", "Anders", "Erik", "Bo", "Carsten", "6", "3", "6", "4"],
    # Match 8: Draw — equal sets won (1-1, no third set decided)
    ["02/04/2026", "Stadion", "Anders", "Bo", "Carsten", "Erik", "6", "3", "3", "6"],
    # Match 9: Unfinished third set (4-3) — match abandoned mid-set
    ["16/04/2026", "Stadion", "Bo", "Erik", "Anders", "Carsten", "6", "4", "4", "6", "4", "3"],
]
